      ...
      <div className="footer-wrapper">
        ...
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-0">
          ...
          <ul class="nav col-md-4 justify-content-end">
            <li class="nav-item"><a href="#" class="nav-link px-2 text-body-light footp">Kezdőlap</a></li>
            <li class="nav-item"><a href="#" class="nav-link px-2 text-body-light footp">Árak</a></li>
            <li class="nav-item"><a href="#" class="nav-link px-2 text-body-light footp">GY.I.K</a></li>
            <li class="nav-item"><a href="#" class="nav-link px-2 text-body-light footp">Rólam</a></li>
          </ul>
        </footer>
